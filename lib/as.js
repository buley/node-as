...
if( !!args.attachments && args.attachments.length > 0 ) {
	...
	for ( x = 0; x < xlen; x += 1 ) {
		...
		attachments.push(Private.object({
		  ...
		  image_url: attachment.attachment_image_url,
		  image_height: attachment.attachment_image_height,
		  image_width: attachment.attachment_image_width,
		  provider_display_name: attachment.attachment_provider_name,
		  provider_url: attachment.attachment_provider_url,
		  url: attachment.attachment_attachments,
