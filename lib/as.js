...
if( !!args.attachments && args.attachments.length > 0 ) {
	...
	for ( x = 0; x < xlen; x += 1 ) {
      ...
      author: !!attachment.author ? attachment.author : ActionStreams.actor({
        ...
        updatedattachment attachment.attachment_author_updated,
...
var result = ActionStreams.activity({
  ...
  target: ActionStreams.target({
    ...
    object: ActionStreams.object({
      author: ActionStreams.actor({
        attachments: args.target_object_author_attachments,
        content: args.target_object_author_content,
        display_name: args.target_object_author_display_name,
        downstream_duplicates: args.target_object_author_downstream_duplicates,
        upstream_duplicates: args.target_object_author_upstream_duplicates,
        id: args.target_object_author_id,
        image: 'undefined' !== typeof args.target_object_author_image ? args.target_object_author_image : ActionStreams.media({
          height: args.target_object_author_image_height,
          url: args.target_object_author_image_url,
          width: args.target_object_author_image_width
        }),
        object_type: args.target_object_author_object_type,
        published: args.target_object_author_published,
        summary: args.target_object_author_summary,
        updated: args.target_object_author_updated,
        url: args.target_object_author_url
      }),
